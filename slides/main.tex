...
the order stayed arrival order. What governs the cap is an \textbf{escalating floor}: the $k$-th
alert of the day must clear a higher bar ($0.49$, then $0.64$), both \emph{derived} from the cost
sweep, not chosen.}
\end{columns}
\vfill
