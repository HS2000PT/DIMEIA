...
\small Within a 5-alerts/day budget, triage nearly \textbf{quadruples precision} ($0.632$ vs $0.163$) --- but \textbf{no text model beat volatility}. The signal is market context; reported as it fell.
\end{block}
\end{frame}
