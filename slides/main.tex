...
\techbadge{blue}{FNSPID (Hugging Face)}\ \techbadge{blue}{yfinance}\ \techbadge{blue}{Finnhub}\ %
\techbadge{blue}{RSS feeds}\ \techbadge{blue}{SPY (market proxy)}
\techcat{\textcolor{orange!75!black}{Machine learning}}
\techbadge{orange}{Sentence-BERT / MiniLM}\ \techbadge{orange}{scikit-learn}\ %
\techbadge{orange}{PyTorch (CPU)}\ \techbadge{orange}{Platt calibration}\ \techbadge{orange}{ONNX Runtime}
\techcat{\textcolor{green!55!black}{Product \& delivery}}
\techbadge{green}{Telegram Bot API}\ \techbadge{green}{Streamlit}\ \techbadge{green}{Plotly}
\techcat{\textcolor{purple!70}{Engineering \& infrastructure}}
\techbadge{purple}{Python 3.12}\ \techbadge{purple}{GitHub Actions (cron)}\ \techbadge{purple}{pytest $+$ ruff}\ %
\techbadge{purple}{joblib}
\par\bigskip
