...
\end{block}
\smallskip
{\footnotesize The cap is now served by descending calibrated score. Small in code; it makes the
trained component \textbf{decide} rather than merely be \textbf{measured}.}
\end{columns}
\vfill
