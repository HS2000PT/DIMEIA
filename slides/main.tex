...
\title[CLARION]{Explainable Financial Alerts for Retail Investors}
...
\begin{frame}{What CLARION does --- and does not do}
...
\begin{tikzpicture}[font=\small, >={Stealth[length=2mm]},
  ...
  \node[sys] (s) at ($(t1)!0.5!(t2)+(3.4,0)$) {\textbf{CLARION}};
...
\begin{itemize}
  ...
  \item By design: \textbf{no price prediction, no trading} --- profit metrics out of scope.
\end{itemize}
\vfill
