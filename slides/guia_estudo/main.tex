...
\begin{itemize}
  ...
  \item \key{Canal Telegram} — varredura automática com \key{filtro de relevância}, chão de
        ...
        também fins de semana (só notícias). Produtores: VM em modo vigia ($\sim$5 min, com
        \key{deteção intradiária} via cotação em tempo real) + cron do GitHub como rede de
        segurança, com dedup partilhado.
