...
\begin{itemize}
  \item \key{Dashboard público} — \texttt{investigator.streamlit.app}: os dois gatilhos e a
        avaliação, no browser. (Usa o embedder \emph{baseline} sobre uma fatia curada de 2.016
        manchetes FNSPID 2018--2023; o SBERT e o seu ganho medido estão na página Evaluation.)
  \item \key{Canal Telegram + timer} — o GitHub Actions varre a watchlist seg--sex após o fecho
        US e publica alertas explicados no canal. Anti-repetição de notícias ($\leq 2$ dias) e
