...
\end{block}
\smallskip
{\footnotesize O tecto passa a ser servido por pontuação calibrada decrescente. Pouco código; faz
o componente treinado \textbf{decidir} em vez de ser apenas \textbf{medido}.}
\end{columns}
\vfill
