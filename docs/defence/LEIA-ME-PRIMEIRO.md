...
`archive/thesis-versions/`, 126 páginas), ao longo de várias sessões. O que vais entregar e
defender é a **tese em português** (`tese-pt/`, 129 páginas), que é um documento diferente: tem
