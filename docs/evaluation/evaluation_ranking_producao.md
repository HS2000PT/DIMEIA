...
> **Gerado a:** 2026-09-08 14:52 UTC

## Bloco insuficiente

O protocolo exige **80 pares empresa-dia com rótulo maturado** antes de reportar qualquer métrica de comparação, e existem **12**. Nenhum valor é publicado.
...
| | |
|---|---:|
| Linhas no registo | 42108 |
| Utilizáveis (classe A, `as_of` não posterior à notícia, sem repetição) | 1182 |
| Pares empresa-dia com rótulo maturado | 12 |
| Mínimo exigido | 80 |

## A recolha chega ao mínimo a tempo?

Ao ritmo observado de **12 pares por dia de bolsa**, e com **8 dias de bolsa** até 2026-09-17, a projeção é de **176 pares**, contra um mínimo de 80. A recolha está no caminho certo.
...
Hoje há **80** pares recolhidos, dos quais **12** já maturaram. A projeção supõe que o ritmo se mantém e que o sistema continua no ar, e não é uma garantia.
