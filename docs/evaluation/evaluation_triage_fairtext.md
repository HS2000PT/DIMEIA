...
**Veredicto (reportado tal como cai):** com o C afinado, texto reduzido por PCA e o encoder de domínio FinBERT, **o texto NÃO supera a volatilidade**.
