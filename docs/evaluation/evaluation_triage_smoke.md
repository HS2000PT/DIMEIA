# evaluation_triage_smoke.md — Triagem (RQ4): CORRIDA-FUMO preservada (corpus Finnhub 4 semanas)

> Cópia congelada da smoke evaluation (M3) antes do retreino FNSPID (M6). A tabela viva está em
> `evaluation_triage.md`. Valor histórico: mostra o regime shift do corpus curto (treino 67,8% vs
> teste 37,2% positivos) que motivou o FNSPID.
