...
operação. Nenhuma foi escolhida por preferência: todas decorrem da restrição fundadora de
utilizar apenas fontes gratuitas, e as duas exceções a essa restrição, que são o alojamento e
...
\begin{tikzpicture}[font=\scriptsize, >={Stealth[length=2mm]},
  ...
  \node[font=\tiny, text=black!60, align=center] at (3.05,-0.95) {\gls{SBERT} em\ ONNX, 384-d};
