...
Estes votos não substituem a avaliação com utilizadores que a Secção~\ref{sec:con_limitacoes} identifica como a lacuna de maior peso deste trabalho, e que permanece por realizar.
