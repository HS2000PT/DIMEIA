...
\begin{axis}[
  ...
  yticklabels={Só texto do título, Árvores com contexto e texto,
...
\node[font=\scriptsize, text=igGreenDark, anchor=south] at (axis cs:3,0.72) {célula usada};
...
\begin{axis}[
  ...
  ytick={alfa, acaso},
  yticklabels={Desempate por ordem alfabética, Escolha aleatória},
