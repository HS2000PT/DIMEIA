...
A Secção~\ref{sec:av_feedback} reporta votos de leitores do canal, e não constitui
exceção a esta lacuna. Um botão colocado ao lado de um alerta público não é um estudo:
vota quem quer, o que empurra a amostra para os extremos; nenhum grupo recebeu a variação
de preço sem a explicação, pelo que nada atribui a utilidade à explicação em si; e o canal
é público, pelo que se desconhece se quem responde pertence ao público que este trabalho
assume. O que esses votos medem é utilidade percebida por quem se dispôs a responder, e a
hipótese fundadora diz respeito a decisão melhor, que é outra quantidade. A ausência
descrita neste parágrafo mantém-se por inteiro.
