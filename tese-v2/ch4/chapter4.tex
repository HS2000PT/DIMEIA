...
\begin{tikzpicture}[
  ...
  \node[proc, dashed, below=6mm of tri] (dec)
    {\textbf{Decomposition}\\ \footnotesize mercado, setor,\\ \footnotesize empresa};
...
\begin{tikzpicture}[font=\footnotesize, >={Stealth[length=2.2mm]},
  ...
  \node[et]  (a) at (0,0)     {\textbf{day $t$}\\ a varredura observa um título relevante};
  \node[esp] (b) at (3.55,0)  {kept as a candidate, with its vector};
  \node[et]  (c) at (7.0,0)   {\textbf{day $t+8$}\\ o impacto é observável};
  \node[et]  (d) at (10.5,0)  {integra a \textbf{case base}};
...
\begin{tikzpicture}[font=\scriptsize, >={Stealth[length=2mm]},
  ...
  \node[cx]  (v) at (5.0,0)  {validação\\ \emph{calibration}};
