...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.88\textwidth]{figures/app_v6_empresa.png}

\vspace{4mm}
\includegraphics[width=0.88\textwidth]{figures/app_v6_silencio.png}
\caption[Vistas da aplicação web]{Aplicação web em funcionamento a 1 de setembro de 2026, durante
a sessão norte-americana. Em cima, a vista de uma empresa: o veredicto em palavras antes de
qualquer número, e a repartição do movimento nas três parcelas. Em baixo, o funil de decisões do
dia: cada porta encurta a barra pelas empresas que trava, e a última, a verde, é o que foi
entregue. As capturas são geradas a partir de um instantâneo congelado da própria aplicação, e não
recolhidas à mão.}
...
descida de $0{,}38\%$, e a parcela específica da empresa era $+0{,}56\%$ — positiva. A descida
provinha do mercado, com $-0{,}72\%$, e do setor, com $-0{,}22\%$. A variação percentual isolada
indica que a empresa caiu e conduz à procura de uma causa interna que não existe; a repartição
mostra que a empresa subiu contra um mercado em queda. O veredicto termina na expressão
\emph{``so far today''}, uma vez que a captura corresponde a meio da sessão e não a um fecho.

A vista inferior mostra a mesma decisão do lado do silêncio. Das doze empresas varridas nesse dia,
uma parou por falta de notícia recente, uma por não existir precedente suficientemente próximo, e
cinco porque o orçamento diário de cinco alertas já estava gasto; cinco foram entregues. A barra de
cada porta encurta pelas empresas que ela trava, o que torna a atrição visível sem exigir a leitura
de qualquer número.
