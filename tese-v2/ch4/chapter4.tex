...
11 de julho, a meio da janela observada. A Figura~\ref{fig:sis_seletividade} apresenta a distribuição
por empresa.
...
cobertura por empresa é desigual.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.60\textwidth]{figures/app_v6_empresa.png}

\vspace{3mm}
\includegraphics[width=0.74\textwidth]{figures/app_v6_silencio.png}
\caption[Vistas da aplicação web]{Aplicação web em funcionamento a 20 de agosto de 2026, durante a
sessão norte-americana. Em cima, a vista de uma empresa. Em baixo, as decisões do dia pela ordem
em que foram tomadas, com indicação da margem em falta quando aplicável.}
...
\subsection{Limitações do ciclo}

O ciclo não inclui retreino. Os parâmetros correspondem ao período de 2018 a 2023 e não foram
reajustados, apesar de a deriva se encontrar medida. A operação seria tecnicamente possível, dado
que os rótulos novos derivam dos preços observados; o impedimento é que o retreino com o registo
de produção alteraria os valores reportados neste documento, e a avaliação dessa alteração exige
tempo de observação que não estava disponível. A Secção~\ref{sec:con_futuro} enuncia-o como
trabalho futuro.
