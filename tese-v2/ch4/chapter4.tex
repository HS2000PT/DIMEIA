...
à superfície, e toda a cor utilizada tem legenda. As capturas são geradas a partir de um
...
número, a repartição do movimento nas três parcelas, e a série de preço com os dias que o detetor
assinalou. As setas indicam a direção do fecho desse dia e nada mais; a data e o valor de $z$ de
cada dia estão nas fichas por baixo do gráfico, e não sobre a linha, para não se sobreporem.}
