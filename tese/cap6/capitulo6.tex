...
corrido a tempo. Enquanto isso não acontecer, a metade ``útil'' da QI3 fica sem resposta, e é assim
que está escrito.
...
\begin{enumerate}
  \item \textbf{Correr o estudo com utilizadores.} Seis a dez pessoas, quinze minutos cada. Fecha a
        metade em aberto da QI3 e é a única coisa desta lista que não se pode acelerar com mais
