...
aritmeticamente correta. Medido num mesmo dia sobre as 17 empresas do mapa de setores, que é o conjunto que o procedimento de avaliação percorre e não a lista de empresas vigiadas implantada: o motor identificado foi a
...
estimação, cuja mediana foi $0.460$. \textbf{Numa dessas 17 empresas foi negativo}, o que significa que,
...
\subsection{Não será um acidente do meu montagem?}
...
O resultado negativo aguenta os três testes. Não é um acidente do meu montagem: é o que os dados dizem.
...
de ordenação do modelo tem um intervalo de confiança a $95\%$ de $[0.391, 0.601]$ em torno de $0.494$, ou seja um
intervalo que contém confortavelmente o acaso. A leitura correta não é que o modelo seja pior do que
...
\subsection{E o que é que o porta estava a escolher, afinal?}
\label{sec:av_portao}
...
A pergunta é simples. O porta implantado era um limiar fixo sobre a probabilidade calibrada: passa
...
\end{tikzpicture}
\caption[O que o porta separava]{Para cada empresa, o intervalo de todas as pontuações que o
