...
2026 --- cerca de 750 dias por empresa.
...
percentil 99 dos retornos \emph{daquela} empresa. É um rótulo imperfeito --- é ele próprio relativo à
volatilidade --- e por isso vem em segundo lugar.
...
e em $35.3\%$ dos dias na mais volátil --- ou seja, para uma delas quase nunca diz nada e para a
...
Este é o primeiro dos dois casos em que uma técnica mais sofisticada foi comparada de forma justa com
uma mais simples --- e perdeu. É um resultado que vale por si: justifica por medição a escolha do
método simples, em vez de a justificar por preferência.
...
\textbf{relevante} se pertencer ao \emph{mesmo setor} da notícia de consulta. É imperfeito --- duas
notícias do mesmo setor podem não ter nada a ver --- mas tem duas virtudes: é objetivo, e não foi
...
A leitura é direta. Escolher ao acaso acerta em $24\%$ dos casos --- é esse o chão, e não zero,
porque há cinco setores e alguns são maiores do que outros. Procurar por palavras em comum sobe para
$34.6\%$. Comparar significado sobe para $51.4\%$, mais do dobro do acaso.

E a alternativa que parece mais razoável de todas --- ``mostra-me simplesmente as notícias mais
...
podem ser sobre o mesmo assunto e o preço ter ido para lados opostos --- foi exatamente o que
...
O melhor modelo da tabela é o mais simples de todos: o que usa \textbf{apenas a volatilidade
...
Serve --- e aqui é preciso muito cuidado com a comparação, porque é fácil enganar-se.
...
a volatilidade média de cada empresa, calculada só sobre o bloco de treino, sem ler uma única
manchete --- obtém $0.662$ e \textbf{bate o modelo treinado}. O que a evidência sustenta, portanto, é
...
A explicação mais provável não é que o modelo esteja avariado --- é que esteja a \textbf{mais}.
...
Duas das três respostas são afirmativas e uma é negativa. A negativa é a que eu mais aprendi a
