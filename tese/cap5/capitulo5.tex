...
$0.513$, chão $0.259$ e margem $+0.254$; o teste simétrico de escala dá $0.595$ \\
...
texto acrescenta} ao que o modelo já sabe da empresa: $+0.012$, IC $[+0.004, +0.020]$; abaixo do
critério prático e sem ganho na precisão@5 \\
\bottomrule
\end{tabular}
\end{table}
