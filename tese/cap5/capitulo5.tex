...
O denominador muda: a precisão divide pelo que o sistema \emph{disse}; a cobertura, pelo que
\emph{existia}. A regra fixa ilustra o conflito: cobre $0.992$ dos dias invulgares, mas tem precisão
$0.122$ porque fala quase sempre. É preciso uma medida que não premie nenhum destes extremos.
...
A média harmónica puxa o resultado para o pior dos dois valores. Por exemplo, para o \emph{z}-score:
\begin{equation*}
  F_1 = 2 \cdot \frac{0.381 \times 0.800}{0.381 + 0.800}
      = 0.516
\end{equation*}

Aplicada à regra fixa, dá $0.218$; com os valores arredondados impressos a conta dá $0.217$. A
diferença vem das casas decimais não mostradas. O \emph{z}-score ganha apesar de ter menos cobertura,
porque triplica a precisão.
...
\emph{As escolhas foram comparadas com alternativas concretas?}
