...
opção pela simplicidade que atravessa todo o trabalho. Medido, porém, \emph{por cima} de uma base que sabe tudo da empresa e nada da notícia, em vez de contra ela, o título acrescenta uma quantidade pequena e mensurável, o que situa o limite: a informação que ele traz distingue empresas, e não notícias.
...
reported, and that validates by measurement the simplicity-first stance running through the work. Measured \emph{on top of} a baseline that knows everything about the company and nothing about the news item, rather than against it, the headline does add a small and measurable amount, which locates the limit: the information it carries separates companies, not news items.
