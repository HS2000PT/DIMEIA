...
de execução não é óbvia e tem uma consequência que descobri à minha custa.
...
O resultado está na Tabela~\ref{tab:sis_latencia}, e é mais informativo do que a
decisão:
