...
A empresa da figura é um caso instrutivo, e não foi escolhido por ser bonito: a ação fechou
praticamente na mesma, $+0.15\%$, e a repartição mostra que isso não foi um dia sem história.
Foram duas forças a anularem-se, com o setor a puxar $+1.25\%$ e a própria empresa $-1.37\%$.
É exatamente a diferença que a segunda pergunta do trabalho existe para tornar visível, e que
uma percentagem sozinha esconde.
...
funcionamento a 20 de agosto de 2026. \textbf{Em cima}, uma empresa. \textbf{Em baixo}, as
