...
\begin{table}[ht]
\caption[As portas e as suas constantes]{As portas que têm uma constante associada, e de onde
vem cada valor. A porta ``já avisei hoje'' não aparece porque não tem constante nenhuma, e o
