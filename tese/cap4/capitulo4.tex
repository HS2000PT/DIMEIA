...
\begin{figure}[p]
\centering
\includegraphics[width=0.76\textwidth]{figures/app_v6_empresa.png}

\vspace{4mm}
\includegraphics[width=0.92\textwidth]{figures/app_v6_silencio.png}
...
amanhã comparam-se contra o que o sistema viu ontem. A Figura~\ref{fig:sis_ciclo_kb} mostra
o ciclo.
...
\emph{gigabytes} por dia de tráfego, o que é insustentável e é, muito provavelmente, a
...
\emph{Onde é que está, concretamente, a engenharia de inteligência artificial deste trabalho?}
...
ter escolhido \emph{por medição}, contra quatro alternativas, incluindo dois modelos específicos de
finanças que perderam. É uma dependência \textbf{essencial}: sem representação de frases não há
...
utilizador. A Secção~\ref{sec:ctx_llm} explica porquê, e a razão é a mesma que atravessa o trabalho:
uma frase gerada é uma afirmação, e este sistema entrega afirmações com a evidência ao lado.

\subsection{O que este ciclo não tem}

Duas coisas, e ambas são consequência de uma só causa.

\textbf{Não há re-treino.} Os pesos são de 2018--2023 e não voltaram a ser ajustados, apesar de a
deriva estar medida. Re-treinar exigiria rótulos novos, e os rótulos novos vêm dos preços, portanto
seria possível; o que impede não é a técnica, é que re-treinar com o registo de produção mudaria os
números que este documento reporta, e essa mudança tem de ser feita com tempo para a avaliar. Fica
como trabalho declarado.

\textbf{Não há verdade humana.} Os três rótulos deste trabalho, ou seja movimento anormal,
mesmo setor e percentil de movimento, são aproximações verificáveis, e nenhuma delas foi
confrontada com o julgamento de uma pessoa. É a limitação de que mais dependem as outras, e o
