...
& grátis, licença \emph{CC BY-SA} & É público, é grande, e traz título, data e empresa. O
alinhamento com preços que este trabalho usa é construído aqui; comprar histórico de notícias
equivalente não era opção. \\
\addlinespace
...
e cujos sintomas incluem exatamente este. Entre os factores de risco que enumeram estão as
\emph{dependências de dados} instáveis e o emaranhamento entre componentes; o caso aqui é uma
variante deles, em que a correção de uma peça depende de uma suposição sobre outra que ninguém
escreveu em lado nenhum. Aqui a suposição era ``o ficheiro que escrevi continua lá amanhã'', e ela é verdadeira
