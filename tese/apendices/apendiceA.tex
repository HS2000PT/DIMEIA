...
cita esse ficheiro. A Tabela~\ref{tab:ap_numeros} liga cada resultado ao procedimento que o gera.
Os restantes números do documento são de dois tipos, e nenhum deles é uma medição minha: valores
retirados das fontes citadas, e constantes de configuração do sistema.
