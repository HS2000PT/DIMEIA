...
Os restantes números do documento são de dois tipos: valores retirados das fontes citadas e
constantes de configuração do sistema. Os primeiros estão citados no sítio onde aparecem; os
segundos estão na Tabela~\ref{tab:sis_portas}, com a distinção entre os que foram derivados e os
