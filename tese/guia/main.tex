...
\title[Guia de estudo]{Guia de estudo do InvestiGator}
...
Usas \textbf{estatística} (técnica 1), \textbf{aprendizagem profunda já treinada por outros}
(técnica 2) e \textbf{aprendizagem automática treinada por ti} (técnica 3).\\
...
% ═══════════════ NÍVEL 3 ═══════════════
\begin{frame}{\key{Nível 3}, técnica 2: frases como pontos}
\begin{itemize}
...
Porque interessa \emph{sobre o que} a frase fala, não o comprimento do texto. Uma manchete curta e
...
% ═══════════════ NÍVEL 4 ═══════════════
\begin{frame}{\key{Nível 4}, técnica 3: o teu modelo}
\begin{itemize}
...
empresa e \key{0,385} entre empresas: o limiar estava a separar empresas, não manchetes. Em
