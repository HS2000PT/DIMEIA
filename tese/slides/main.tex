...
\vspace{2mm}
\begin{center}
\large E fica com \textbf{três perguntas} --- sempre estas, sempre por esta ordem.
\end{center}
\end{frame}
...
\textbf{O dia julgado não entra no cálculo da sua própria norma} --- sem isto, seria batota.
\end{frame}
...
\end{center}
\vspace{1mm}
Cada manchete vira \textbf{384 números} --- uma coordenada de significado.\\
...
\begin{enumerate}
  ...
  \item \textbf{A técnica mais simples ganhou duas vezes.}\\
        \footnotesize Ao Isolation Forest, e ao modelo com texto.
\end{enumerate}
\vspace{3mm}
\begin{center}
