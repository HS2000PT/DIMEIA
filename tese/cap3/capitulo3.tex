...
de 2026. O procedimento que a gera consta do Apêndice~\ref{ap:reprodutibilidade} e decompõe sempre a
última sessão fechada à data em que corre, pelo que reproduzir estes valores exatos exige fixar essa
data.
...
$-0.253$ da volatilidade, $+0.236$ da casa do setor tecnológico, $+0.006$ do movimento do dia,
$-0.003$ do comprimento do título, $+0.067$ das restantes casas de setor, e o termo constante
$-0.025$. Total: $\mathbf{+0.029}$. \\
\addlinespace
