...
\emph{Uma dissertação que constrói uma coisa e depois a mede: como é que isso se avalia?}
...
distingue-se de um estudo puramente empírico por uma razão simples: aqui a coisa avaliada não
...
uma coisa falsa com números verdadeiros.
...
\begin{tikzpicture}[font=\small, >={Stealth[length=2.4mm]}, scale=1.0]
  ...
  \begin{scope}
    ...
    \node[font=\footnotesize, black!55] at (1.85,1.02) {$\theta$ pequeno};
  ...
  \begin{scope}[xshift=7.4cm]
    \draw[->, black!35] (0,0) -- (4.3,0);
    \draw[->, black!35] (0,0) -- (0,3.3);
    \draw[->, very thick, black!75] (0,0) -- (3.9,0.6)
      node[right, black, align=left, font=\footnotesize] {título A};
    \draw[->, very thick, black!75] (0,0) -- (0.75,3.05)
      node[above, black, align=left, font=\footnotesize] {título C};
    \draw[black!55] (1.35,0.21) arc (8.7:76.2:1.37);
    \node[font=\footnotesize, black!55] at (1.72,1.35) {$\theta$ quase recto};
    \node[align=center, font=\footnotesize] at (2.1,-0.75)
