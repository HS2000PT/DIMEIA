...
O \texttt{-1} final garante a exclusão; se o desvio-padrão for zero, a última linha devolve zero em
vez de dividir. Esta prevenção de \emph{lookahead} é imposta por teste automático na
Secção~\ref{sec:met_avaliacao}.
