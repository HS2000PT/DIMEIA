...
Na prática, $r_m$ é o retorno de um fundo cotado que segue o índice largo do mercado americano, e
$\tilde r_s$ o de um fundo setorial escolhido a partir do mapa de setores desta secção. Daí decorrem
duas ressalvas que a equação não deixa ver, e nenhuma delas é neutra.
...
arruma como tecnologia não pertencem ao fundo setorial correspondente: a classificação da indústria
coloca-as em consumo discricionário e em serviços de comunicação. Nesses casos a regressão mede a
