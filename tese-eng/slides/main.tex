...
\begin{itemize}
  ...
  \item The method beats chance in all \textbf{five sectors}: $0.448$ in energy, with a floor
        of $0.072$. No advantage over a \textbf{filter using the query's known sector} was measured.
