...
\emph{Robo-advisor} & --- & --- & --- & \% of portfolio \\
Professional terminal & \checkmark & \checkmark & \checkmark & thousands/year \\
...
\begin{tikzpicture}[font=\tiny, x=7.0cm, y=0.245cm]
  ...
  \node[right, text=orange!60!black] at (0.655,2.5) {always passes};
...
\vspace{-1mm}
\begin{center}
In \textbf{84\%} of the decisions, the outcome was determined\\
by the \textbf{company} before the headline was read.
\end{center}
\vspace{1mm}
{\footnotesize Apple could not produce a news alert at all. AMD passed in $963$ of $963$.}
\end{frame}
