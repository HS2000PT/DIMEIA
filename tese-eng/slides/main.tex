...
People & \textbf{3} \\
\midrule
Called the alert useful & \textbf{86 of 91} $= 95\%$ \; {\scriptsize $[88,98]$} \\
The same, without the reader who gave $58\%$ of them & \textbf{34 of 38} $= 89\%$ \; {\scriptsize $[76,96]$} \\
\bottomrule
\end{tabular}
\\[1mm]
{\scriptsize in brackets, the 95\% Wilson interval}
\end{center}
\vspace{1.5mm}
