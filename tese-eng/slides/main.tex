...
{\footnotesize In words, before the number: $141$ of the last $250$ days moved
this much or more. The verdict is \emph{``Quiet''}, and it comes before any value.}
\vspace{3mm}

\textbf{2. Was it the company?}\\
{\footnotesize \textbf{All of it was.} The stock rises $0.99\%$ while the market
($-0.47\%$) and the sector ($-0.54\%$) pulled the other way: the company's
part is $+2.00\%$. And the line below says this company's fit sits
\textbf{below} the median.}
\vspace{3mm}
