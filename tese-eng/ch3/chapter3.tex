...
The four decisions presented so far draw on distinct families of technique, and the question of
where machine learning sits in this work has a different answer for each of them. Table~\ref{tab:met_onde_ia}
gathers that answer, which would otherwise remain scattered across the preceding sections, and
