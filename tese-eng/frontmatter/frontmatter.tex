...
\listoftables
% The List of Listings is NOT printed and the command renaming its prefix was removed: the
% rewrite for this tree left the document WITHOUT A SINGLE code listing, and the comment that
% used to be here defended keeping a list that no longer has content. The anti-lookahead
% guarantee, which was the listing worth showing, became the rolling-window figure in the
% methods chapter, which serves better the reader this dissertation addresses.
...
$F_1$ & Harmonic mean of precision and recall, $2PC/(P+C)$ & Section~\ref{sec:av_desenho} \\
\end{symbols}
