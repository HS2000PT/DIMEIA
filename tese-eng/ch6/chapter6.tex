...
Figure~\ref{fig:con_simples} gathers the six.
...
\begin{tikzpicture}[font=\scriptsize,
  ...
  \draw[draw=black!30] (3.2,1.7) -- (3.2,-4.05);
\end{tikzpicture}
\caption[The three occasions in each direction]{On the left, the three occasions on which a simpler technique obtained a better result than a more sophisticated one under equivalent conditions. On the right, the three on which the reverse happened and the system nonetheless kept the deployed option, with the reason for each. The distinction between the two columns is the distinction between a result and a choice, and Table~\ref{tab:av_alternativas} gathers them with the rest.}
