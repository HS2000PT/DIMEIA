...
around $0.072$, the method obtains several times that value with a smaller absolute margin. The
...
too, and faster, so the margin falls from $+0.274$ to $+0.262$. The method does not degrade with
...
expect a different outcome --- it delivers the underlying computation, and it is the absence of
