...
$\beta_{\text{ref}} = 0{,}0$, uma vez que o resíduo de uma ortogonalização tem média nula e a
ausência de exposição setorial é, por isso, a hipótese neutra. O desvio-padrão comum de $0{,}5$
...
têm de sair idênticas, porque nenhuma delas pode observar o futuro; os rótulos têm de sair
