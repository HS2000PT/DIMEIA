...
produção contém duas empresas ausentes de todos os conjuntos históricos e uma terceira que
consta do mapa canónico mas não do conjunto de dados da triagem.}
