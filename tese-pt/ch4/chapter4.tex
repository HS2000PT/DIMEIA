...
\begin{tikzpicture}[font=\footnotesize,
  ...
  \foreach \nome/\valor/\tipo/\quota/\y in {
      ...
      {Piso escalonado}/{0{,}64}/{d}/{nunca atuou}/{-4.15},
  ...
  \node[lin, font=\scriptsize, text=black!65, text width=12.2cm] at (0,-5.95)
    {O ponto que elimina quase tudo é um dos escolhidos, e é-o em todos os dias medidos. Dos dois
     ...
     agosto de 2026 e o piso escalonado continua armado mas nunca atuou, por o orçamento se esgotar
...
Tabela~\ref{tab:sis_portas}. A leitura que a figura permite, e que a tabela sozinha não dá, é a
de que a redução de volume não é feita pelos pontos cujo valor foi derivado: é feita pelo
