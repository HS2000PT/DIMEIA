...
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{app_v8_empresa.png}
\end{column}
...
\begin{itemize}
  ...
  \item A \key{repartição} responde à segunda pergunta: a ação sobe $0{,}99\%$ e o
        mercado e o setor puxavam ao contrário, logo a subida é toda da \textbf{empresa}.
  \item A \key{qualidade do ajuste} vem por baixo: aqui fica \textbf{abaixo} da
        mediana, e o produto di-lo.
  \item Os \key{marcadores} separam os dias que deram alerta dos que o detetor
        só assinalou.
\end{itemize}
\end{column}
\end{columns}
...
\key{0{,}395} vs \key{0{,}200} & precisão@5: significado vs \emph{sempre tecnologia} & QI2 \\
0{,}196 / 0{,}117 & idem: palavras em comum / acaso uniforme & QI2 \\
\key{0{,}513} / 0{,}259 / $+0{,}254$ & P@5 com anterioridade / chão / margem; não testa maturação & QI2 \\
...
\begin{frame}{\key{Nível 5}: a única evidência de utilidade, e o que ela não é}
\textbf{Primeiro a ressalva, depois o número} --- é nesta ordem que se diz, e é a ordem que te
protege.

\medskip
\textbf{O que é.} Cada alerta do canal leva dois botões. Quem quiser carrega. As regras de
análise ficaram escritas \emph{antes} de existir o primeiro voto: mínimo de 20 votos para
reportar uma percentagem, um voto por pessoa e por alerta, e se uma pessoa der mais de 40\% dos
votos a conta repete-se sem ela.

\medskip
\textbf{O que mede.} Se quem recebeu achou o alerta útil. Nada mais.

\medskip
\textbf{O que NÃO mede.} Não há grupo que tenha recebido a variação de preço \emph{sem}
explicação, logo nada disto atribui a utilidade à explicação. Vota quem quer, o que empurra a
amostra para os extremos. E achar útil não é decidir melhor: essa é a hipótese fundadora do
trabalho, e continua por testar.

\medskip
\textbf{Os números.} \key{91} votos sobre \key{62} alertas, de \key{3} pessoas. \key{86 de 91}
disseram útil, ou seja \key{95\%}, intervalo de Wilson $[88\%;98\%]$. Sem o leitor que deu
\key{58\%} dos votos: \key{34 de 38}, ou seja \key{89\%}, intervalo $[76\%;96\%]$.
\end{frame}

\begin{frame}{\key{Nível 6}: «e o senhor, votou?»}
É a pergunta que o quadro anterior convida, e tens de a responder em uma frase, sem hesitar.
Três pessoas, uma com 58\% dos votos: qualquer arguente faz a subtração.

\medskip
\textbf{Se não votaste:} «Não. Verifiquei contra o registo, e nenhum dos três é o meu.»

\medskip
\textbf{Se votaste mas não és o dominante:} «Votei em alguns, uma parte pequena dos 91. O
votante dominante, que dá 58\%, não sou eu.»

\medskip
\textbf{Se és o dominante:} «Sim. E é por isso que o protocolo repete a conta sem mim: restam
38 votos e \key{34 deles}, ou seja \key{89\%}, continuam a dizer útil. Os 95\% incluem-me; os 89\% não.»

\medskip
\textbf{Isto melhorou e vale a pena saber porquê.} Em setembro eram 42 votos, e sem o votante
dominante restavam 14, abaixo do mínimo de 20, logo a verificação \emph{não existia} e a
única resposta era «o protocolo recusa o recorte». Agora há um número. \textbf{Decide qual das
três frases é a tua antes da defesa}, e não à frente do júri.
\end{frame}
