...
mecanismo de dano que os autores descrevem --- negociação por realimentação do preço, por oposição
ao uso de informação sobre o valor da empresa --- é precisamente o que se instala quando ao
...
sistema aqui em causa --- vigiar acontecimentos e notificar o investidor particular --- é tratada
...
publicados; tem de ser enunciada como diferença de postura epistémica, entre estimar o que vai
...
documentado em domínios onde o custo de o ignorar é elevado \autocite{ancker2017alertfatigue}, e
cuja transposição para este domínio deixou de ser necessária desde que existe medição feita sobre
investidores particulares \autocite{liu2023alerts}, discutida na
...
Estas cautelas são gerais. Sobre a opção concreta desta dissertação --- explicar por casos ---
...
confiante, por comparação com o estilo indutivo --- que é o estilo baseado em exemplos, ou seja o
...
de referência, nunca como um sistema em funcionamento contínuo contra fontes reais.

Esta última afirmação precisa de uma ressalva, e a Secção~\ref{sec:ctx_ferramentas} deu-lhe o
nome. Sistemas integrados para este público existem e estão publicados, sendo o mais desenvolvido
o de \textcite{muntermann2009ubiquitous}. A diferença face a esse trabalho não é de integração,
que ele também fez, mas de duas outras coisas. A primeira é a postura epistémica: aquele sistema
estima o efeito de preço que se seguirá ao comunicado, e este mede o efeito que já se produziu e
explica-o. A segunda é o objeto da avaliação: aquele mede a oportunidade económica por simulação,
e este mede a qualidade daquilo que entrega, contra dados reais e ao longo de um período de
funcionamento. Enunciada assim, a lacuna é mais estreita do que uma afirmação de ausência, e é
defensável.
