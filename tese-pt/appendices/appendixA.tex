...
A secção indicada na terceira coluna enuncia, para cada resultado, o protocolo, a linha de base contra a qual foi comparado e a população sobre que
...
Quatro causas foram medidas e corrigidas, que no conjunto reduziram o pico de $970$ para $663$\,MB
e nenhuma das quais foi suficiente: o conjunto de trabalho da aplicação excede genuinamente um
contentor de $512$\,MB, uma vez que as bibliotecas numéricas e o motor de inferência ocupam, por
si, $158$\,MB, e a matriz de precedentes torna-se residente assim que a primeira consulta lhe
percorre as páginas.
