...
Linguagem Natural e Sistemas Conversacionais &
  Semelhança semântica entre frases e avaliação de recuperação sensível à ordem. O texto entregue
  é composto a partir dos objetos calculados. Uma camada de geração ancorada, em que cada frase é
  obrigada a citar um facto e o número que cita é verificado, foi construída e avaliada, e não é exposta,
  pela razão de garantia apresentada no Capítulo~\ref{cap:sistema} &
