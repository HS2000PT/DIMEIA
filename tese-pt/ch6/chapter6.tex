...
dessas dezassete empresas, e a nomear em palavras o caso em que o ajuste não descreve os dados. A estimativa
...
\section{A fronteira da afirmação}
\label{sec:con_final}

A contribuição enuncia-se ao seu nível exato, e a separação importa mais do que qualquer uma das
metades. O que este trabalho estabelece é que o sistema está tecnicamente preparado para sustentar
explicações assentes em evidência histórica verificável: toda a quantidade apresentada provém do
componente que a calculou, pode ser conferida contra o registo no momento em que é lida, e a
política que decide o silêncio está documentada e medida. O que este trabalho não estabelece é que
esta forma de explicação conduza o investidor particular a uma decisão melhor. Essa é a hipótese
fundadora, permanece por testar, e o seu teste é o primeiro item da secção anterior.
A Figura~\ref{fig:con_fronteira} apresenta a separação.
