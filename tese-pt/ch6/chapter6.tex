...
decisões que conduziram ao silêncio. Ao longo dos períodos documentados no
Capítulo~\ref{cap:avaliacao} foram entregues $367$ mensagens, entre 9 de julho e 13 de
agosto de 2026, e registadas $36\,925$ decisões de triagem sobre uma janela mais
ampla, e a base de precedentes acumulou $38\,214$ casos com impacto medido. Estes números
...
\begin{tikzpicture}[font=\footnotesize,
  ...
  \node[num] at (7.2,-2.35) {supera o valor de referência nos cinco setores; sob a restrição
    temporal da produção, precisão@5 de $0{,}513$ contra acaso de $0{,}259$};
