...
Figura~\ref{fig:con_simples} reúne as seis.
...
\begin{tikzpicture}[font=\scriptsize,
  ...
  \node[perde] at (6.4,-3.24) {\textbf{MPNet} obtém mais, e não foi adotado\\[1pt]\scriptsize precisão@5 de $0{,}538$ contra $0{,}514$ · custo};
  \draw[draw=black!30] (3.2,1.7) -- (3.2,-4.05);
\end{tikzpicture}
\caption[As três ocasiões em cada sentido]{À esquerda, as três ocasiões em que uma técnica mais simples obteve melhor resultado do que uma mais sofisticada em condições equivalentes. À direita, as três em que sucedeu o inverso e o sistema conservou mesmo assim a opção implantada, com a razão de cada uma. A distinção entre as duas colunas é a distinção entre resultado e escolha, e a Tabela~\ref{tab:av_alternativas} reúne-as com as restantes.}
...
negativa apresentada com o mesmo destaque das duas restantes. A resposta à segunda questão
...
\begin{tikzpicture}[font=\scriptsize,
  ...
  \node[res] (c13) at (10.8,-2.72) {$0{,}514$\\ contra $0{,}240$};
  \draw[seta] (c10) -- (c11);
  \draw[seta] (c11) -- (c12);
  \draw[seta] (c12) -- (c13);
...
margem desce de $+0{,}274$ para $+0{,}262$.
...
da watchlist, e a nomear em palavras o caso em que o ajuste não descreve os dados. A estimativa
