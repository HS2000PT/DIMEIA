...
\end{axis}
\end{tikzpicture}
\caption[Recuperação: o método contra seis alternativas]{Precisão@5 do MiniLM implantado, em verde
cheio, contra seis alternativas. O contorno verde identifica a variante MPNet de maior dimensão; as
barras cinzentas reúnem duas linhas de base, uma linha lexical e um codificador específico do domínio
financeiro. A alternativa tracejada de devolver sempre notícias do setor maior obtém $0{,}467$ sem
qualquer modelo, valor discutido no texto e que obriga a ler o agregado com reserva.}
...
\item \textbf{O texto continua a não separar notícias da mesma empresa.} A capacidade de ordenação
...
A informação que o texto traz distingue empresas e períodos, e não notícias.
