...
% ⚠ O TÍTULO DIVERGE DO DA DISSERTAÇÃO, e este comentário afirmava o contrário.
% A dissertação intitula-se «InvestiGator: alertas financeiros explicáveis para o investidor
% particular», com o subtítulo «...sobre fontes de dados gratuitas»; estes slides e o artigo
% usam «Explicar sem prever» e «...em alertas verificáveis». Um dos dois tem de mudar, e a
% escolha é do autor, por ser a primeira coisa que o júri lê. Enquanto não estiver decidido,
% o comentário diz o que é verdade em vez de descrever uma sincronia que não existe.
