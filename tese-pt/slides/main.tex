...
\includegraphics[height=0.68\textheight]{app_v8_empresa.png}
\end{column}
\begin{column}{0.35\textwidth}
\small
\textbf{1. É invulgar?}\\
{\footnotesize Em palavras, antes do número: $141$ dos últimos $250$ dias
moveram-se tanto ou mais. O veredicto é \emph{``Quiet''}, e é dito antes de qualquer valor.}
\vspace{3mm}

\textbf{2. Foi a empresa?}\\
{\footnotesize \textbf{Foi toda ela.} A ação sobe $0{,}99\%$ e o mercado
($-0{,}47\%$) e o setor ($-0{,}54\%$) puxavam ao contrário: a parcela da
empresa é $+2{,}00\%$. E a linha por baixo diz que o ajuste desta
empresa fica \textbf{abaixo} da mediana.}
\vspace{3mm}
...
\end{center}
\vspace{1mm}
\begin{center}\includegraphics[width=0.97\textwidth,height=0.46\textheight,keepaspectratio]{app_v7_silencio.png}\end{center}
