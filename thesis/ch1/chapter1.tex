...
growing share of it now comes from ordinary people using commission-free mobile apps rather than from
...
below US\$50{,}000 \autocite{gallup2025stock}. What they share is a hard position. Markets move continuously
across thousands of securities and relevant news arrives throughout the trading day, yet retail investors
have none of the tools that banks and funds take for granted.
...
A retail investor who wants to stay informed faces two distinct challenges. The first is telling a
genuinely unusual price move apart from ordinary daily volatility, which takes statistical judgement and
constant attention. The second is reading what a news item might mean, which takes knowledge of how
similar events played out in the past, knowledge most people do not have to hand. Existing consumer
applications often provide alerts with little explanation, or rely on models whose reasoning is hidden
from the user.
...
explanations. The incremental, simplicity-first way the system is built is a methodological choice,
described in Chapter~\ref{chap:methods}.
