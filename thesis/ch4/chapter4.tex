...
calls, dashed arrows are returns; time runs downward. The correlation engine orchestrates the work: it
embeds the headline, consults the knowledge base, and assembles the retrieved precedents and their
...
arrows are calls, dashed arrows are returns; time runs downward. The detector standardises the latest return
