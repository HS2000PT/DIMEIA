...
return against its rolling window, and hands the move, together with every quantity behind it, to the
explanation engine for delivery, but only when the absolute $z$-score exceeds the threshold.
