...
dissertation** compiles cleanly (`thesis/main.pdf`, 113 pp, 0 errors), with **63 references each verified by
...
## Repository layout
```
thesis/        LaTeX dissertation (6 chapters + front matter + appendix; 113 pp)
...
- Verification loop: `bash scripts/verify.sh` (646 tests + lint + LaTeX note).
