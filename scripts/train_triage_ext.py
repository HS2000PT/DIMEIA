...
- `tese-pt/figures/eval_triage_ext.pdf`         (barras da contribuição marginal por feature)
...
def main() -> int:
    ...
    fig.tight_layout()
    figpath = REPO / "tese-pt" / "figures" / "eval_triage_ext.pdf"
    fig.savefig(figpath)
    print(f"\nFigura: {figpath}")
    ...
    lines += [
        "",
        "![Contribuição marginal](../../tese-pt/figures/eval_triage_ext.pdf)",
        "",
