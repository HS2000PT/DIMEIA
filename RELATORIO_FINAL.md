...
- **Tese** (`thesis/`, EN-GB): 6 capítulos canónicos MEIA, **128 pp, 0 erros, 0 citações
...
- **707 testes automáticos + ruff**, verdes localmente e no CI (runner limpo a cada push).
...
thesis/main.pdf         A TESE (128 pp)               thesis/main.tex + ch1..ch6/
