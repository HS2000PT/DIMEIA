...
## Estado Atual
- **Sessão nº:** 23 (**REVISÃO EDITORIAL TOTAL** da tese, capítulo a capítulo — texto natural/humano em EN-GB, sem tiques de IA, sem mexer em conteúdo/números; só faltam tarefas **humanas** — declaração ISEP de IA + data, e leitura final do aluno)
