...
## Estado Atual
- **Sessão nº:** 22 (**PASSAGEM DE REVISÃO TIPO-JÚRI** sobre a tese inteira; correções genuínas implementadas, 0 fabricação; só faltam tarefas **humanas** — declaração ISEP de IA + data, e leitura final do aluno)
