...
sistema sonda por isso num ciclo fixo, que chega para as afirmações que faz, e o enunciado honesto da
limitação é que a latência está limitada por esse ciclo e é \emph{medida} em vez de prometida. Um
produto dirigido a negociação intradiária precisaria do caminho de streaming; este não é esse produto,
e dizê-lo é mais barato e mais verdadeiro do que construir uma capacidade que não se usa.
