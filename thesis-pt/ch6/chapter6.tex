...
diárias, e os precedentes recuperados têm dias por construção. Os dois perfis de utilizador descritos
no Capítulo~\ref{chap:introduction} foram também interrogados sobre o que notariam, e nenhum distingue cinco
segundos de cinco minutos num alerta que existe para provocar reflexão e não uma ordem de compra. O
sistema sonda por isso num ciclo fixo, que chega para as afirmações que faz, e a limitação é
\emph{medida} em vez de prometida.
...
\begin{itemize}
  ...
  \item Atacar a lacuna de texto em aberto da RQ4: texto mais rico do que manchetes (corpo dos
        ...
        aprendida natural.
  \item Como produto, medir o que a pipeline de notícias nunca chega a ver. A cobertura da fonte
        gratuita é hoje uma limitação assumida e não uma grandeza: a fração das histórias que
        realmente movem o mercado e que chegam sequer ao funil nunca foi contada, e contá-la
        converteria uma suposição num número, como já se fez para a deriva e para a incerteza.
\end{itemize}
